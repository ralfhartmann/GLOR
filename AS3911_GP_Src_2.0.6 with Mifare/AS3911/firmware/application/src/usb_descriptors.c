...
/** \file
  USB descriptors, tailored for AS3911 firmware */
...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0xC801,                 // Product ID: AS3911 general purpose Demoboard with PIC
...
ROM BYTE configDescriptor1[]={
    ...
    64,0x00, //sizeof configDescriptor1 // Total length of data for this cfg
